...
/**
 * @brief Imprime o cabecalho do projeto.
 */
void print_header() {
	printf("\n.--------------------------.--------------------------.\n");
...
/**
 * @brief Imprime o rodape do projeto.
 */
void print_footer() {
	printf("\n.---------------------------.---------------------------.\n");
...
/**
 * @brief Imprime uma mensagem a indicar que se trata do transmissor.
 */
...
/**
 * @brief Imprime uma mensagem a indicar que se trata do recetor.
 */
void print_receiver() {
	printf("\n.----------------.\n");
		printf("|    RECEIVER    |\n");
...
/**
 * @brief Imprime uma tabela com os valores disponiveis da baudrate, pela RS-232.
 */
void print_baudrate() {
...
/**
 * @brief Pede ao utilizador que insira a baudrate, o numero de retransmissoes, o intervalo de time-out e o tamanho maximo do campo de informacao.
 */
void ask_parameters() {
	print_baudrate();
	scanf("%d", &BAUDRATE);
...
/**
 * @brief Funcao que  cria e escreve o pacote de controlo START.
...
/**
 * @brief Funcao que envia um pacote de dados.
 * @param fd - descritor da porta.
...
/**
 * @brief Funcao que  cria e escreve o pacote de controlo END.
 * @param fd - descritor da porta.
 * @param fileName - nome do ficheiro.
 * @param fileSize - tamanho do ficheiro.
 */
...
/**
 * Maquina de estados para receber pacotes.
 * @param fd - descritor da porta.
 */
...
/**
 * Funcao para enviar o ficheiro, dividindo-o em varios pacotes.
 * @param fd - descritor da porta.
 * @param fileName - nome do ficheiro.
 * @param fileSize - tamanho do ficheiro.
 * @param fileContent - conteudo do ficheiro.
 */
